...
const portfolio_data = [    
    {
        ...
        des: <>Potrai programmare gli appuntamenti ricorrenti per tutto l'anno.</>,
        delay: ".5s",
        category: "Agenda",
        filter_id: ["all", "Agenda", "Branding", "Marketing", "Illusutration", "App Design" ],
    }, 
    {
        id: 2,
        thumb_img: thumb_img_2,
        brand_logo: brand_logo_2, 
        job_title: "Agenda, Marketing",
        title: <>Pacchetti Promozionali</>,
        des: <>Gestisci i tuoi pacchetti promozionali o pacchetti sconto .</>,
        delay: ".5s",
        category: "Agenda",
        filter_id: ["all", "Agenda", "Sito Web", "Marketing", "Illusutration", "App Design" ],
    }, 
    {
        id: 3,
        ...
        job_title: "Agenda, Marketing",
        title: <>Promemoria via SMS-Whatsapp</>,
        des: <>Alla notifica email della prenotazione aggiungi la stessa  via SMS o Whatsapp.</>,
        delay: ".5s",
        category: "Agenda",
        filter_id: ["all", "Agenda", "Sito Web", "Marketing", "Illusutration", "App Design" ],
    }, 
    {
        ...
        job_title: "Sito Web",
        title: <>Sito Web</>,
        des: <>Sito web della tua attività con incluso il modulo di prenotazione online.</>,
        delay: ".5s",
        category: "Sito Web",
        filter_id: ["all", "Agenda", "Sito Web", "Marketing", "Illusutration", "App Design" ],
    }, 
    ...
    }, 
    {
        ...
        title: <>Carta fedeltà</>,
        des: <>Crea un programma Fedeltà per fidelizzare la tua clientela.</>,
        delay: ".5s",
